...
public class DanhSachDangKyKhoiThiTapTheMau1 {
	...
	public static final String tenDoi = "$ten_doi$";
	...
	public static final List<String> colMap = Arrays.asList(thuTu, tenDoi, soBaoDanh, hoTen, ngayThangNamSinh, gioiTinhNam,
